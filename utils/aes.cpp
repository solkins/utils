...
const unsigned int FT0[256] = {FT};
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
const unsigned int FT1[256] = {FT};
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
const unsigned int FT2[256] = {FT};
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
const unsigned int FT3[256] = {FT};
#undef V

#undef FT

const unsigned int RSb[256] = {
...
#define V(a,b,c,d) 0x##a##b##c##d
const unsigned int RT0[256] = {RT};
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
const unsigned int RT1[256] = {RT};
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
const unsigned int RT2[256] = {RT};
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
const unsigned int RT3[256] = {RT};
#undef V
...
aes::aes(unsigned char *key, int nbits)
{
    int i;
    unsigned int *RK, *SK;
...
void aes::encrypt(unsigned char input[], unsigned char output[])
{
...
void aes::decrypt(unsigned char input[], unsigned char output[])
{
    unsigned int *RK, X0, X1, X2, X3, Y0, Y1, Y2, Y3;
